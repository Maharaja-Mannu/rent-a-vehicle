...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $cnfpwd=htmlspecialchars(stripslashes($_POST['cnfpwd']));
...
if(isset($_POST['submit'])){
  ...
  if($nameErr==false && $emailErr==false && $phoneErr==false && $pwdErr==false){ 
    ...
    <div id="signUpForm" class="container">
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" class="col-sm-12">
            ...
            <div class="row">
                ...
                <input type="text" name="name" id="name" class="col-sm-7 col-xs-12" value="<?php echo $name;?>" placeholder="Name" required>
            </div>
            <div class="row">
